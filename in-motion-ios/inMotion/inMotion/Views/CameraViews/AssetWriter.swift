...
//        }
//        
//        self.assetWriter = try? AVAssetWriter(outputURL: URL(fileURLWithPath: filePath), fileType: .mp4)
//        
...
//            ] as [String : Any]
//        
//        self.videoInput = AVAssetWriterInput(mediaType: .video, outputSettings: writerOutputSettings)
