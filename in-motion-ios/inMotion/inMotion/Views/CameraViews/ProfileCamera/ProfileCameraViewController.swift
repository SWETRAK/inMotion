    ...
    func fileOutput(_ output: AVCaptureFileOutput, didFinishRecordingTo outputFileURL: URL, from connections: [AVCaptureConnection], error: Error?) {
        if error == nil {
            do {
                ...
                self.appState?.uploadProfileVideo(
                    fileData: videoData,
                    fileName: outputFileURL.absoluteString,
                    successUploadProfileVideo: { ProfileVideoUploadInfoDto in
                        print(ProfileVideoUploadInfoDto)
